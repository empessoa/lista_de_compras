 ...
 */
public class Frag_Calculo extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.frag__calculo, container, false);
        edt_peso_produto_1 = (EditText) view.findViewById(R.id.edt_peso_produto_1);
        edt_peso_produto_1.addTextChangedListener(Mask.insert(Mask.MASK_PESO, edt_peso_produto_1));
        edt_peso_produto_2 = (EditText) view.findViewById(R.id.edt_peso_produto_2);
        edt_peso_produto_2.addTextChangedListener(Mask.insert(Mask.MASK_PESO, edt_peso_produto_2));
        edt_valor_produto_1 = (EditText) view.findViewById(R.id.edt_valor_produto_1);
        edt_valor_produto_1.addTextChangedListener(new MonetaryMask(edt_valor_produto_1) {
        });
        edt_valor_produto_2 = (EditText) view.findViewById(R.id.edt_valor_produto_2);
        ...
        txtv_informar_produto = (TextView) view.findViewById(R.id.txtv_informar_produto);
        txtv_produto_1 = (TextView) view.findViewById(R.id.txtv_produto_1);
        txtv_produto_2 = (TextView) view.findViewById(R.id.txtv_produto_2);
